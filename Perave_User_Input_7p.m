...
energyspread = 33;                                           % Absolute energy spread MeV
...
%param.chi2 = e0/me/c^2; % These are the helical ones
%param.chi1=mu0*c/2*param.I/param.A_e; % These are the helical ones
%const_resp=1/param.chi2*(param.lambdau/2/param.lambda0);

param.chi2 = e0/me/c^2/2; % These are the planar ones
param.chi1=mu0*c/2*param.I/param.A_e; %These are the planar ones
% Constant for the resonant phase calculation   
const_resp=1/param.chi2*(param.lambdau/2/param.lambda0);
% This is not right for the planar case it has to be multipled by JJ(z) and
% a factor of 2 see my notebook and/or Alex' paper for answers
